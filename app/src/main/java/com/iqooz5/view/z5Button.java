 ...
 *
 */
public class z5Button extends Button {
    ...
    public z5Button(Context context) {
        super(context);
        this.setClickable(true);
    }

    public z5Button(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setClickable(true);
    }

    public z5Button(Context context, AttributeSet attrs, int defStyle) {
